                ...
                if (localArgsTracker){
                             if (localArgs!=null) {
                                   ...
                                   for (int i = 0;i < localArgs.length;i++){
                                        ...
                                        // write null attribute
                                           writeStartElement(null, "http://productSW", "args", xmlWriter);
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"main".equals(type)){
                                ...
                                return (Main)classes.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://productSW","args").equals(reader.getName()) || new javax.xml.namespace.QName("","args").equals(reader.getName()) ){
                                    ...
                                    // Process the array and step past its final element's end.
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://productSW","args").equals(reader.getName())){
